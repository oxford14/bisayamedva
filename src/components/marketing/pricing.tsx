  ...
  return (
    <section className={`bg-white bg-grid ${sectionPad}`}>
      <Container className="grid items-center gap-12 lg:grid-cols-[1fr_1fr] lg:gap-20">
        ...
        <div className="shine-border rounded-[28px] border border-border bg-cream p-8 shadow-[0_24px_60px_rgba(11,31,58,0.08)] sm:p-10">
          ...
          <p className="mt-1 text-muted">{site.featuredCourse.priceLabel}</p>
